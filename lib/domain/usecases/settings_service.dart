import 'package:ns_buddy/domain/entities/settings.dart';
import 'package:ns_buddy/domain/interfaces/settings_repository_interface.dart';
import 'package:ns_buddy/domain/interfaces/settings_service_interface.dart';
...
class SettingsService implements SettingsServiceInterface {
  ...
  //   if (_settings.disablePersistence) return;
  ...
  Future<void> setUseDynamicColors(bool value) async {
    return await repository.setUseDynamicColors(value);
  }
